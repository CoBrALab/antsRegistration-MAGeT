...
for transform in transforms:
  print(transform, end=' \\\n')
  print("\t--metric Mattes[${{fixedimage}},${{movingimage}},1,{},Regular,0.5]".format(bins[slicestart+slicesize]), end=' \\\n')
...
print("\t--metric Mattes[${{fixedimage}},${{movingimage}},1,{},None]".format(bins[-1]), end=' \\\n')
print("\t--convergence [{},1e-7,10]".format("x".join(iterations[len(shrinks)-5:])), end=' \\\n')
