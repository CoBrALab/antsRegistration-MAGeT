...
print("--metric Mattes[${{fixedfile}},${{movingfile}},1,{},Regular,0.95] ".format(bins[0]), end=' ')
...
print("--metric Mattes[${{fixedfile}},${{movingfile}},1,{},Regular,0.95]".format(bins[2]), end=' ')
...
print("--metric Mattes[${{fixedfile}},${{movingfile}},1,{},Regular,0.95]".format(bins[3]), end=' ')
...
print("--metric Mattes[${{fixedfile}},${{movingfile}},1,{},Regular,0.95]".format(bins[4]), end=' ')
print("--convergence [{},1e-6,10]".format("x".join(iterations[3:])), end=' ')
print("--shrink-factors {}".format("x".join(shrinks[3:])), end=' ')
print("--smoothing-sigmas {}mm".format("x".join(blurs[3:])), end=' ')
print("--masks [${fixedmask},${movingmask}]", end=' ')
